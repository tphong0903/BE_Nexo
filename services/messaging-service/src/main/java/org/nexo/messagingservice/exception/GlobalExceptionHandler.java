package org.nexo.messagingservice.exception;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.FORBIDDEN)
    public ResponseData<?> handleSecurityException(SecurityException ex, WebRequest request) {
        log.warn("Security exception: {} - Path: {}", ex.getMessage(), request.getDescription(false));
        return ResponseData.builder()
                .status(HttpStatus.FORBIDDEN.value())
