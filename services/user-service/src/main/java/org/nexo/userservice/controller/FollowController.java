...
public class FollowController {
        ...
        public ResponseData<?> getFollowings(@RequestHeader(HttpHeaders.AUTHORIZATION) String authHeader) {
                String accessToken = authHeader.replace(BEARER_PREFIX, "").trim();
                Set<FolloweeDTO> followings = followService.getFollowings(accessToken);
                return ResponseData.builder()
                                .status(200)
