...
public class FollowServiceImpl implements FollowService {
        ...
        public PageModelResponse<PublicUserDTOResponse> getSuggestedFriends(String accessToken, Pageable pageable) {
                String keycloakUserId = jwtUtil.getUserIdFromToken(accessToken);
                UserModel currentUser = userRepository.findByKeycloakUserId(keycloakUserId)
                                .orElseThrow(() -> new ResourceNotFoundException("User not found"));
