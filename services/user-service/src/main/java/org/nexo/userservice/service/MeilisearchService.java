...
public class MeilisearchService {
    ...
    public void updateUser(UserSearchDocument document) throws JsonProcessingException, MeilisearchException {
        String json = objectMapper.writeValueAsString(document);
    ...
    public void reindexAllUsers(List<UserSearchDocument> users) throws JsonProcessingException, MeilisearchException {
